...
```{r}
FLightR.data<-read.tags.light.twilight(lig.raw, end.date="2014-05-17")
...
Current tag measures data every minute (`measurement.period=60`) and saves maximum over 2 minutes (`saving.period=300`)

add calibration location as x,y
```{r}
start=c(5.43, 52.93)

log.light.borders=c(2.5, 8)
log.irrad.borders=c(-3,1.5)
```
## Part 2. Calibration
