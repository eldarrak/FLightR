...
```
### Find calibration location for known calibration periods
...
i et al. 2012](#lisovski_2012a) implemented in GeoLight [Lisovksi et al. 2012a](#Lisovski_2012b). If bird is assumed to be stationary at some period one can try:
```{r}
