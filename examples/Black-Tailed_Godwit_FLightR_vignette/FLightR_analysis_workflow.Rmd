...
[Lisovski et al. 2012b](#lisovski_2012b) implemented in GeoLight [Lisovksi et al. 2012a](#Lisovski_2012b). If bird is assumed to be stationary at some period one can try:
```{r, eval=FALSE}
# ~ 15 min run time
