...
```{r, eval = F}
library(devtools)
install_github("eldarrak/FLightR@0.3.8") # note the version
library(FLightR)
```
...
## Spatial extent
Set up a spatial grid (50 X 50 km on default) and limit the ...Set the boundaries..???????
```{r, eval = F}
...
#Below is old workflow that will be updates soon
