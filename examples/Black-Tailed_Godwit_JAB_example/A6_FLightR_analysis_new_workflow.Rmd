...
# FLightR analysis
This is a new workflow for FLightR>=0.3.9 based on the original Appendix A6 to 
...
## Install package
We used FLightR 0.3.9 version, so you might want to install it if you want to get exactly the same results.
