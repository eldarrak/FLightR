...
Download [.lux](https://raw.githubusercontent.com/eldarrak/FLightR/master/examples/black-tailed_godwit_Intigeo_tag_example/A2_raw_data.lux) file into your working directory. I assume you will name it 'A2_raw_data.lux'.
...
```
Now you can read these data by [GeoLight](https://github.com/slisovski/GeoLight) or [FLightR](https://github.com/eldarrak/FLightR).
