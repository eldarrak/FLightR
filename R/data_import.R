...
#' @param start.date date of beginning of relevant data collection in POSIXct format.
#' @param end.date date of end of relevant data collection in POSIXct format.
